...
router.post(
  ...
  (req, res, next) => {
    ...
    const doctor = new Doctor({
      ...
      arabicLevel: req.body.arabicLevel,
      description: req.body.description,
      specialityDegree: req.body.specialityDegree,
      specialityDegreeCompleteion: req.body.specialityDegreeCompleteion,
      specialityDegreeInstitute: req.body.specialityDegreeInstitute,
